...
class UpdateApiProjectList(ModelForm):        
      ...
      class Meta:
          ...
          DEL_ANA = [('None','None'),('Yang Xu','Yang Xu'), ('Waldy Capule','Waldy Capule'), ('Ronald Macalipay','Ronald Macalipay'), ('Maricar Garzon','Maricar Garzon'), ('Louie John Diaz','Louie John Diaz'), ('Leslie Aubrey Igaharas','Leslie Aubrey Igaharas'), ('Khumille Lopez','Khumille Lopez'), ('Justine Carmel Tayag','Justine Carmel Tayag'), ('Joy Angelie Baltazar','Joy Angelie Baltazar'), ('Joey Alvarado','Joey Alvarado'),('Joel Juatchon','Joel Juatchon'), ('Finella Francesca Panganiban','Finella Francesca Panganiban'), ('Eileen Faye Placido','Eileen Faye Placido') ,('Diana Asis','Diana Asis'),  ('Wilbur Dionglay','Wilbur Dionglay'), ('Jui Hsia Soon Liu','Jui Hsia Soon Liu'), ('Shara Dyan Escobido','Shara Dyan Escobido'), ('Jasmine Jake Halili','Jasmine Jake Halili'), ('Sharisse Perez','Sharisse Perez'), ('James Domogma','James Domogma')]
